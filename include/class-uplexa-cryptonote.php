<?php
/*
  Copyright (c) 2018 uPlexa-Integrations
*/
...
require_once('class-uplexa-base58.php');

class uPlexa_Cryptonote
{
    protected $ed25519;
    public function __construct()
    {
        $this->ed25519 = new ed25519();
        $this->base58 = new uPlexa_base58();
        $this->address_prefix = UPLEXA_GATEWAY_ADDRESS_PREFIX;
        $this->address_prefix_integrated = UPLEXA_GATEWAY_ADDRESS_PREFIX_INTEGRATED;
    }

...
class uPlexa_Explorer_Tools
{
    private $url;
    public function __construct($testnet = false)
    {
        $this->url = $testnet ? UPLEXA_GATEWAY_TESTNET_EXPLORER_URL : UPLEXA_GATEWAY_MAINNET_EXPLORER_URL;
    }
